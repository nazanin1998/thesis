...
class ReadPhemeJsonDS(ABC):

    # 1. extract events from json dataset and Convert theme to EventModel
    # 2. convert event model list to csv dataset
    # 3. save dataset to project dir
